...
[![SkillIcons](https://skillicons.dev/icons?i=react,tailwind,express,nodejs,django,nginx,py,git,mongodb,postman,bash,npm)](https://skillicons.dev)<br/>

and here are the ones i am looking to upskill:

[![SkillIcons](https://skillicons.dev/icons?i=java,c,mongodb,postman,bash,npm,opencv,tensorflow,threejs,vercel)](https://skillicons.dev)<br/>
